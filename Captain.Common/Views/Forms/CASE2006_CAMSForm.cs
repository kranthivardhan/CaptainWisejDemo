...
{
    public partial class CASE2006_CAMSForm : Form
    {
        ...
        public CASE2006_CAMSForm(BaseForm baseform, string CAMS_flg, string CAMS_desc, string hierarchy, string year, CASEACTEntity pass_entity, PrivilegeEntity privileges, string MST_site, string MST_intakeWorker, List<FldcntlHieEntity> caFldcEntity, CASESP0Entity sp_header_rec, List<CASEACTEntity> CA_template_list, string sp_start_Date, string spm_site, string sp_End_Date)
        {
            ...
            if (dtAgy.Rows.Count > 0)
            {
                if (dtAgy.Rows[0]["ACR_CAOBO"].ToString().Trim() == "Y")
                    ACR_BenefitFrom = dtAgy.Rows[0]["ACR_BENEFIT_FROM"].ToString().Trim();
                else ACR_BenefitFrom = string.Empty;
            }
            ...
            else
            {
                ...
                Tools["CA_Notes"].Visible = false; Tools["CA_Pdf"].Visible = false;

                ACR_BenefitFrom = BaseForm.BaseAgencyControlDetails.BenefitFrom.Trim();
            }
            ...
            switch (CAMS_FLG)
            {
                ...
                case "CA":
                    ...
                    Tools["MS_Notes"].Visible = false;
                    Tools["MS_Help"].Visible = false;

                    Tools["CA_Pdf"].Visible = true;
                    Tools["CA_Notes"].Visible = true;
                    Tools["CA_Help"].Visible = true;

                    CAPanel.Visible = pnlCAServFields.Visible = true;

                    MSPanel.Visible = false;
                    Sel_HH_Mem_Panel.Visible = false;
                    CT_Post_Triggers.Visible = false;
                    HS_Post_Triggers.Visible = false;
                    Bulk_Posting_Panel.Visible = false;
                    pnlActSeekDate.Visible = false;
                    this.Size = new System.Drawing.Size(this.Size.Width, this.Size.Height - (MSPanel.Height + Sel_HH_Mem_Panel.Height + CT_Post_Triggers.Height + HS_Post_Triggers.Height + Bulk_Posting_Panel.Height + Lbl_CA_Header.Height));
                    //LblProgramReq.Visible = Cmb_Program.Enabled = true;
                    if (Lbl_UOM.Visible == false) {

                        pnlCATop2.Visible = false;
                        this.pnlCAServFields.Size = new System.Drawing.Size(this.pnlCAServFields.Width, this.pnlCAServFields.Height - pnlCATop2.Height);
                        this.Size = new System.Drawing.Size(this.Size.Width, this.Size.Height - pnlCATop2.Height);
                    }
                    if (pnlActSeekDate.Visible == false) {
                        this.Size = new System.Drawing.Size(this.Size.Width, this.Size.Height - pnlActSeekDate.Height);
                    }
        ...
        public CASE2006_CAMSForm(BaseForm baseform, string CAMS_flg, string CAMS_desc, string hierarchy, string year, CASEMSEntity pass_entity, PrivilegeEntity privileges, string MST_site, string MST_intakeWorker, List<FldcntlHieEntity> msFldcEntity, CASESP0Entity sp_header_rec, List<CASEMSEntity> MS_template_list, string sp_start_Date, string spm_site, string sp_End_Date)
        {
            ...
            switch (CAMS_FLG)
            {
                case "MS":
                    ...
                    //this.Size = new System.Drawing.Size(507, 377);//365


                    Tools["MS_Notes"].Visible = true;
                    Tools["MS_Help"].Visible = true;

                    Tools["CA_Pdf"].Visible = false;
                    Tools["CA_Notes"].Visible = false;
                    Tools["CA_Help"].Visible = false;
                    ...
                    Bulk_Posting_Panel.Visible = false;
                    pnlActSeekDate.Visible = false;
                    this.Size = new System.Drawing.Size(this.Size.Width, this.Size.Height - (CAPanel.Height + Sel_HH_Mem_Panel.Height + CT_Post_Triggers.Height + HS_Post_Triggers.Height + Bulk_Posting_Panel.Height + Lbl_CA_Header.Height));

                    if (pnlOutcomedate.Visible == false) {
                        pnlOutcomedate.Visible = false;
                        this.Size = new System.Drawing.Size(this.Size.Width, this.Size.Height - pnlOutcomedate.Height);
                    }
        ...
        public CASE2006_CAMSForm(BaseForm baseform)
        {
            InitializeComponent();
            BaseForm = baseform;
        ...
        public CASE2006_CAMSForm(BaseForm baseform, string hie, string app, int MS_Cnt, List<Captain.Common.Utilities.ListItem> Sel_Members)//, string template_sw)
        {
            InitializeComponent();
            BaseForm = baseform;
        ...
        public CASE2006_CAMSForm(string date, string Exp_post_date, string calling_form)
        {
            InitializeComponent();
        ...
        public CASE2006_CAMSForm(bool age_sw, string lpb_type, string lpb_level, string source, string Check_date, string Check_Fdate, string Check_Tdate, string ben_type, string ben_level)
        {
            InitializeComponent();
        ...
        public CASE2006_CAMSForm(bool tmp, string Attn_SW, string from_Date, string to_Date)
        {
            InitializeComponent();
        ...
        private void Fill_Custom_Questions()
        {
            ...
            if (Cust_Grid.Rows.Count > 0)
                Cust_Grid.Rows[0].Selected = true;
        ...
        private void Btn_CASave_Click(object sender, EventArgs e)
        {
            if (isValidate())
            {
                ...
                if (_model.SPAdminData.UpdateCASEACT(Pass_CA_Entity, Operatipn_Mode, out New_CAID, out New_CA_Seq, out Sql_SP_Result_Message))
                {
                    ...
                    MessageBox.Show("Unable to Save Critical Activity \n" + "Reason : " + Sql_SP_Result_Message, "CAP Systems");
            }
        }
        ...
        private void Add_PROGNotes_For_CAMS(DialogResult dialogResult)
        {
            if (dialogResult == DialogResult.Yes)
            {
                switch (CAMS_FLG)
                {
                    case "CA": CASE2006_CAMSForm_ToolClick(Tools, new ToolClickEventArgs(Tools["CA_Notes"])); break;
                    case "MS": CASE2006_CAMSForm_ToolClick(Tools, new ToolClickEventArgs(Tools["MS_Notes"])); break;
                }
                Get_PROG_Notes_Status();
            }
            else
        ...
        private void Get_PROG_Notes_Status()
        {
            if (Mode.Equals("Edit"))
            {
                ...
                Tools["CA_Notes"].ImageSource = Consts.Icons.ico_CaseNotes_View;
                Tools["MS_Notes"].ImageSource = Consts.Icons.ico_CaseNotes_New;
                ...
                if (caseNotesEntity.Count > 0)
                {
                    ...
                    Tools["CA_Notes"].ImageSource = Consts.Icons.ico_CaseNotes_View;
                    Tools["MS_Notes"].ImageSource = Consts.Icons.ico_CaseNotes_View;
                }
            }
        }
        ...
        private void CASE2006_CAMSForm_Load(object sender, EventArgs e)
        {
            if (CAMS_FLG == "MS")
            {
                ...
                foreach (FldcntlHieEntity entity in CntlMSEntity)
                {
                    ...
                    switch (entity.FldCode)
                    {
                        ...
                        case Consts.CASE0006.MS_Seek_Date:
                            if (enabled) { dtMSSeek_Date.Visible = lblMsSeekDate.Visible = pnlOutcomedate.Visible = true; if (required) lblMSSeekDateReq.Visible = true; } else { dtMSSeek_Date.Visible = lblMsSeekDate.Visible = pnlOutcomedate.Visible = false; lblMSSeekDateReq.Visible = false; }
                            break;
                    }
                }
            }
                ...
                foreach (FldcntlHieEntity entity in CntlCAEntity)
                {
                    ...
                    switch (entity.FldCode)
                    {
                        ...
                        case Consts.CASE0006.Act_UOM:
                            ...
                            if (enabled) { Lbl_UOM.Visible = Cmb_UOM.Visible = Lbl_UOM.Visible = Cmb_UOM.Enabled = Lbl_UOM.Enabled = pnlCAServFields.Visible = true; if (required) LblUOM_Req.Visible = true; } else { Lbl_UOM.Visible = Cmb_UOM.Visible = Lbl_UOM.Visible = Cmb_UOM.Enabled = Lbl_UOM.Enabled = pnlCAServFields.Visible = false; LblUOM_Req.Visible = false; }
                            break;
                        ...
                        case Consts.CASE0006.Act_Seek_Date:
                            if (enabled) { dtActSeek_Date.Visible = lblActSeekDate.Visible = pnlActSeekDate.Visible = true; if (required) lblActSeekDateReq.Visible = true; } else { dtActSeek_Date.Visible = lblActSeekDate.Visible = pnlActSeekDate.Visible = false; lblActSeekDateReq.Visible = false; }
                            break;
        ...
        private void Fill_Members_For_BulkPost()
        {
            ...
            DataSet ds = Captain.DatabaseLayer.MainMenu.MainMenuSearch("APP", "All", null, null, OBF_App, null, null, null, null, null, null, null, null, null, null,
                OBF_Hie, null, BaseForm.UserID, string.Empty, string.Empty, string.Empty);
            if (ds.Tables.Count > 0)
            {
                DataTable dt = ds.Tables[0];
                if (dt.Rows.Count > 0)
        ...
        private void On_PaymentVoucher()
        {
            ...
            try
            {
                ...
                iTextSharp.text.Image _image = iTextSharp.text.Image.GetInstance(Consts.Icons.ico_lg_Righ_Arrow);  //kranthi//iTextSharp.text.Image.GetInstance(Context.Server.MapPath("~\\Resources\\images\\Arrow1.png"));
        ...
        private void CASE2006_CAMSForm_ToolClick(object sender, ToolClickEventArgs e)
        {
            if (e.Tool.Name == "MS_Notes")
            {
            ...
            if (e.Tool.Name == "MS_Help")
            {
            }
            if (e.Tool.Name == "CA_Pdf")
            {
                On_PaymentVoucher();
            }
            if (e.Tool.Name == "CA_Notes")
            {
                string Notes_Field_Name = null;
